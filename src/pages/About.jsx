    ...
    <div className="container mx-auto p-8 bg-gray-50 rounded-lg shadow-lg">
      ...
      <div className="flex flex-col md:flex-row items-center">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            ...
            my journey is driven by a passion for simplifying complex concepts and helping others 
            achieve their goals in the realm of Computer Science.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed">
            I’ve created this blog to serve as a resource hub for students, professionals, 
            and anyone curious about exploring core topics in CSE. 
            Whether it’s understanding key concepts or mastering 
      ...
      <div>
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          ...
          down complex topics into digestible, actionable insights. This blog is built 
